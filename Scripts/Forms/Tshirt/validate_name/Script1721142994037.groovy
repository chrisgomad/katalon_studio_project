...
WebUI.openBrowser('https://forms.gle/Ky2dmTjTXhdeRzmm7')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_T-Shirt Sign Up/span_This is a required question'), 0)
